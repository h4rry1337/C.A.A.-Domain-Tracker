#!/usr/bin/env bash
echo '
  ______ ________  ___ ___ _____ _   _        _____    ___     ___       ___________  ___  _____ _   _____________ 
  |  _  |  _  |  \/  |/ _ |_   _| \ | |      /  __ \  / _ \   / _ \     |_   _| ___ \/ _ \/  __ | | / |  ___| ___ \
  | | | | | | | .  . / /_\ \| | |  \| |______| /  \/ / /_\ \ / /_\ \______| | | |_/ / /_\ | /  \| |/ /| |__ | |_/ /
  | | | | | | | |\/| |  _  || | | . ` |______| |     |  _  | |  _  |______| | |    /|  _  | |   |    \|  __||    / 
  | |/ /\ \_/ | |  | | | | _| |_| |\  |      | \__/\_| | | |_| | | |      | | | |\ \| | | | \__/| |\  | |___| |\ \ 
  |___/  \___/\_|  |_\_| |_\___/\_| \_/       \____(_\_| |_(_\_| |_/      \_/ \_| \_\_| |_/\____\_| \_\____/\_| \_|
